...
T = TypeVar("T", bound="NewVmOverlaybdDisk")


@_attrs_define
class NewVmOverlaybdDisk:
    """
    Attributes:
        boot_order (int):
        disk_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Any) -> T:
        ...
        new_vm_overlaybd_disk.additional_properties = d
        return new_vm_overlaybd_disk
